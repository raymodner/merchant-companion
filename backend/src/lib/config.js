...
export const config = {
  ...
  sharedPaint:         (process.env.SHARED_PAINT          ?? 'true')  !== 'false',
  sharedTribeMarkers:  (process.env.SHARED_TRIBE_MARKERS  ?? 'false') !== 'false',
  sharedRatings:       (process.env.SHARED_RATINGS        ?? 'true')  !== 'false',
  registrationOpen,
